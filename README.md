...
フィールドレコーディングクラブさいたまのAstroサイトです。

## 現状のサイト概要

フィールドレコーディングクラブさいたまの活動紹介と、2026年7月18日開催の「サウンド・コミュニケーション・ウォークさいたま2026」の告知を中心にした静的なランディングページです。
...
- `src/content/reports/` のMarkdown記事を一覧表示
- 日付とタイトルから記事ページへ遷移
- 下見、ワークショップ、展示準備などの活動記録を蓄積

### Program

- 2026年7月18日のプレイベント
- 2026年9月・11月の録音ワークショップ
- 2027年2月の成果展示発表会
...
Peatixへ移動する前に、サイト内でイベント内容を十分に理解できる状態にする。
...
2027年2月の成果展示発表会に向けて、展示の構想や準備過程を見せる。
